...
def train_lgb_with_wandb(
    ...
    # Holdout 데이터 예측
    lgb_holdout_pred = lgb_model.predict(
        X_holdout, num_iteration=lgb_model.best_iteration
    )
...
def cross_validation_lgb_with_wandb(
    X_all,
    y_all,
    lgb_params,
    project_name,
    ...
    final_run = wandb.init(
        project=project_name, name=experiment_name, entity=entity_name, reinit=True
    )
